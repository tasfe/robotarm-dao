package robot.arm.dao.exql.util;
...
public class ExqlUtils {
	private static final Logger log = Logger.getLogger(ExqlUtils.class);

	public static final String PARAM_TAG = ":";// 参数标识
	...
	public static Object execExpr(ExprResolver exprResolver, String expression) {
		...
		try {
			...
			log.error("Can't resolving expression: " + expression, e);
		}
